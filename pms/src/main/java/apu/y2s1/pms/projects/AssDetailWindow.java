 ...
 * @author tenen
 */
public class AssDetailWindow extends javax.swing.JFrame {

    /**
     * Creates new form detailWindow
     */
    public AssDetailWindow() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Assessment Details");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AssDetailWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AssDetailWindow().setVisible(true);
            }
        });
    }
